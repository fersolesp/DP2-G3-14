...
//public class HairdressersUITest {
//
//	@LocalServerPort
//	private int port;
//
...
//
//	@ParameterizedTest
//	@CsvSource({"owner6,0wn3r,Samantha,2020/08/05 20:00"})
...
//
//	@ParameterizedTest
//	@CsvSource({"owner5,0wn3r,George,2020/07/20 18:00",})
...
//		this.as("owner7", "0wn3r")
//		.whenImLoggedInTheSystem()
//		.thenICanCreateAppointment("Lucky", date)
...
//		this.as("owner8", "0wn3r")
//		.whenImLoggedInTheSystem()
//		.thenICanCreateAppointment("Mulligan", date)
...
//		this.as("owner9", "0wn3r")
//		.whenImLoggedInTheSystem()
//		.thenICanNotCreateAppointmentForADateWithOtherAppointment("Freddy","2020/07/20 20:50");
//	}
//
//	// Definición de métodos
//
//	private HairdressersUITest as(final String user,final String password) {
//		this.userName = user;
...
//	}
//
//	private HairdressersUITest whenImLoggedInTheSystem() {
...
//	}
//
//	private HairdressersUITest thenICanCreateAppointment(final String pet,final String date) {
//		this.driver.get("http://localhost:"+this.port);
...
//	}
//
//	private HairdressersUITest whenIHaveNoPets(final String ownerName) {
//		this.driver.get("http://localhost:"+this.port);
...
//	}
//
//	private HairdressersUITest thenICanNotCreateAppointmentWihtoutPets() {
//		this.driver.get("http://localhost:"+this.port);
//		this.driver.findElement(By.xpath("//div[@id='main-navbar']/ul/li[5]/a/span[2]")).click();
//		this.driver.findElement(By.linkText("George Primero")).click();
//		this.driver.findElement(By.linkText("Add New Appointment")).click();
...
//	}
//
//	private HairdressersUITest thenICanNotCreateAppointmentWihtoutPayingOtherAppointments() {
//		this.driver.get("http://localhost:"+this.port);
//		this.driver.findElement(By.xpath("//div[@id='main-navbar']/ul/li[5]/a/span[2]")).click();
//		this.driver.findElement(By.linkText("George Primero")).click();
//		this.driver.findElement(By.linkText("Add New Appointment")).click();
...
//	}
//
//	private HairdressersUITest whenIHaveAnAppointment(final String pet, final String date) {
...
//		return this;
//	}
//	private HairdressersUITest thenICanNotCreateAppointmentForSamePetOnSameDay(final String pet,final String date) {
//		this.driver.get("http://localhost:"+this.port);
//		this.driver.findElement(By.xpath("//div[@id='main-navbar']/ul/li[5]/a/span[2]")).click();
//		this.driver.findElement(By.linkText("George Primero")).click();
//		this.driver.findElement(By.linkText("Add New Appointment")).click();
...
//	}
//
//	private HairdressersUITest thenICanNotCreateAppointmentForInactiveHairdresser(final String pet,final String date) {
//		this.driver.get("http://localhost:"+this.port);
//		this.driver.findElement(By.xpath("//div[@id='main-navbar']/ul/li[5]/a/span[2]")).click();
...
//	}
//
//	private HairdressersUITest thenICanSeeHairdressersAndTheirSpecialities() {
//		this.driver.get("http://localhost:"+this.port);
//		this.driver.findElement(By.xpath("//div[@id='main-navbar']/ul/li[5]/a/span[2]")).click();
//
...
//	}
//
//	private HairdressersUITest thenICanNotDeleteTodaysAppointment() {
//		this.driver.get("http://localhost:"+this.port);
//		this.driver.findElement(By.xpath("//div[@id='main-navbar']/ul/li[4]/a/span[2]")).click();
//		this.driver.findElement(By.linkText("Description example")).click();
...
//	}
//
//	private HairdressersUITest thenICanDeleteAppointmentWhichIsNotToday() {
//		this.driver.get("http://localhost:"+this.port);
//		this.driver.findElement(By.xpath("//div[@id='main-navbar']/ul/li[4]/a/span[2]")).click();
...
//		this.driver.findElement(By.linkText("Description example")).click();
//		this.driver.findElement(By.linkText("Delete Appointment")).click();
//		Assert.assertEquals("There are not appointments yet.", this.driver.findElement(By.xpath("//body/div/div/p")).getText());
//		return this;
//	}
//
//	private HairdressersUITest thenICanNotCreateAppointmentForADateWithOtherAppointment(final String pet,final String date) {
//		this.driver.get("http://localhost:"+this.port);
//		this.driver.findElement(By.xpath("//div[@id='main-navbar']/ul/li[5]/a/span[2]")).click();
//		this.driver.findElement(By.linkText("George Primero")).click();
//		this.driver.findElement(By.linkText("Add New Appointment")).click();
