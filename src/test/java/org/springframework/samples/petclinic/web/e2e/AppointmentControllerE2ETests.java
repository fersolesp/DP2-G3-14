...
class AppointmentE2EControllerTests {
	...
	void shouldNotShowAppointmentsWhenYouHaveNotAppointments() throws Exception {
		...
		.andExpect(MockMvcResultMatchers.model().attributeDoesNotExist("appointments"))
		.andExpect(MockMvcResultMatchers.view().name("appointments/appointmentsList"));
	}
	...
	void shouldShowAppointmentDetails() throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.get("/appointments/{appointmentId}", 1))
		.andExpect(MockMvcResultMatchers.status().isOk())
	...
	void shouldNotShowAppointmentWhenNotFound() throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.get("/appointments/{appointmentId}", 100))
		.andExpect(MockMvcResultMatchers.status().isOk())
		.andExpect(MockMvcResultMatchers.model().attribute("message", "Appointment not found"))
		.andExpect(MockMvcResultMatchers.model().attributeDoesNotExist("appointment"))
	...
	void shouldNotShowAnotherUserAppointment() throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.get("/appointments/{appointmentId}", 1))
		.andExpect(MockMvcResultMatchers.status().isOk())
		.andExpect(MockMvcResultMatchers.model().attribute("message", "You cannot access another user's appointment"))
		.andExpect(MockMvcResultMatchers.view().name("exception"));
	}
	...
	void shouldDeleteAppointment() throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.get("/appointments/delete/{appointmentId}", 1))
	...
	void shouldNotDeleteAppointmentWhenNotFound() throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.get("/appointments/delete/{appointmentId}", 200))
		.andExpect(MockMvcResultMatchers.status().isOk())
		.andExpect(MockMvcResultMatchers.model().attribute("message", "Error: No value present"))
		.andExpect(MockMvcResultMatchers.model().attributeDoesNotExist("appointment"))
		.andExpect(MockMvcResultMatchers.view().name("exception"));
	}
	...
	void shouldNotDeleteAppointmentOfOtherUser() throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.get("/appointments/delete/{appointmentId}", 1))
		.andExpect(MockMvcResultMatchers.status().isOk())
		.andExpect(MockMvcResultMatchers.model().attribute("message", "You cannot delete another user's appointment"))
		.andExpect(MockMvcResultMatchers.view().name("exception"));
	}
	...
	void shouldCreateAppointment() throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.get("/hairdressers/{hairdresserId}/appointments/new", 1))
		.andExpect(MockMvcResultMatchers.status().isOk())
		.andExpect(MockMvcResultMatchers.model().attributeExists("appointment"))
	...
	void shouldNotCreatAppointmentWhenOwnerHasNoPets() throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.get("/hairdressers/{hairdresserId}/appointments/new", 1))
		.andExpect(MockMvcResultMatchers.status().isOk())
		.andExpect(MockMvcResultMatchers.model().attribute("message", "You have no pets to make an appointment"))
		.andExpect(MockMvcResultMatchers.view().name("exception"));
	}
	...
	void shouldNotCreateAppointmentWithOtherAppointmentsNotPaid() throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.get("/hairdressers/{hairdresserId}/appointments/new", 1))
		.andExpect(MockMvcResultMatchers.status().isOk())
		.andExpect(MockMvcResultMatchers.model().attribute("message", "You have to pay previous appointments"))
		.andExpect(MockMvcResultMatchers.view().name("exception"));
	}
	...
	void shouldNotSaveAppointmentWithFormErrors() throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.post("/hairdressers/{hairdresserId}/appointments/new", 1)
			.with(SecurityMockMvcRequestPostProcessors.csrf()))
		.andExpect(MockMvcResultMatchers.status().isOk())
		.andExpect(MockMvcResultMatchers.model().attributeHasErrors("appointment"))
		.andExpect(MockMvcResultMatchers.model().attributeHasFieldErrors("appointment", "date"))
		.andExpect(MockMvcResultMatchers.model().attributeHasFieldErrors("appointment", "pet"))
		.andExpect(MockMvcResultMatchers.view().name("appointments/editAppointment"));
	}
