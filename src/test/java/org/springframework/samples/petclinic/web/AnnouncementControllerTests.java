...
class AnnouncementControllerTests {
	...
	//
	//		this.mockMvc.perform(MockMvcRequestBuilders.get("/inscriptions/{inscriptionId}", 1)).andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.model().attribute("message", "Inscription not found"))
	...
	//
	//		this.mockMvc.perform(MockMvcRequestBuilders.get("/courses/{courseId}/inscription/new", 1)).andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.model().attribute("message", "There are errors validating data"))
	//			.andExpect(MockMvcResultMatchers.view().name("exception"));
	//	}
	//
	//	@WithMockUser(value = "george")
	...
	//		Mockito.when(this.petService.findPets("george")).thenReturn(Lists.newArrayList(this.lillie));
	//
	//		this.mockMvc.perform(MockMvcRequestBuilders.get("/courses/{courseId}/inscription/new", 1)).andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.model().attribute("message", "The course is full"))
	//			.andExpect(MockMvcResultMatchers.view().name("exception"));
	//	}
	//
	...
	//		Mockito.when(this.courseService.findCourseById(1)).thenReturn(Optional.of(dummyCourse));
	//
	//		this.mockMvc.perform(MockMvcRequestBuilders.post("/courses/{courseId}/inscription/new", 1).with(SecurityMockMvcRequestPostProcessors.csrf()).param("date", "2015/02/12").param("isPaid", "false").param("pet.id", this.lillie.getId().toString()))
	//
	...
	//
	//		Mockito.when(this.inscriptionService.findInscriptionById(1)).thenReturn(Optional.of(inscription1));
	//		this.mockMvc.perform(MockMvcRequestBuilders.get("/inscriptions/delete/{inscriptionId}", 1)).andExpect(MockMvcResultMatchers.status().isOk())
